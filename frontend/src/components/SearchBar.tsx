...
const SearchBar = () => {
  ...
  return (
    <form
      ...
      className="-mt-8 p-3 bg-sky-600 rounded-md shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4"
    >
      ...
      <div className="flex gap-1">
        <button className="w-2/3 bg-blue-700 text-white h-full p-2 font-bold text-xl hover:bg-blue-500 rounded-md">
          Search
        </button>
